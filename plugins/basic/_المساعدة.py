...
from jmthon.decorators.asstbot import callback, in_pattern
from jmthon.load_plug import PLUGINS
from database import CMD_HELP, LIST, InlinePlugin, InlinePaths
from .. import HNDLR, LOGS, tgbot, jmdB, jmubot, jmthon_cmd, inline_pic
...
async def inline_handler(event):
    ...
    if inline_pic():
        ...
        result = await event.builder.article(
            title="**⌔∮ قائمة أوامر سورس جمثون**", text=text, buttons=get_help_buttons()
        )
...
async def help_func(moh):
    ...
    _strings = {
        "basic": "**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/Jmthon_Support)**\n**❃ مالك الحساب هو: {}.\n❃ عدد القوائم الموجودة: {}**",
        "account": "**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/Jmthon_Support)**\n**❃ مالك الحساب هو: {}.\n❃ عدد قوائم الموجودة: {}**",
        "fun": "**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/Jmthon_Support)**\n**❃ مالك الحساب هو: {}.\n❃ عدد قوائم الموجودة: {}**",
        "group":"**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/Jmthon_Support)**\n**❃ مالك الحساب هو: {}.\n❃ عدد قوائم الموجودة: {}**",
    }
